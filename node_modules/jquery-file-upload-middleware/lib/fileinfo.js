...
module.exports = function (options) {
    ...
    FileInfo.prototype.setUrl = function (type, baseUrl) {
        ...
        if(type == 'thumbnail') this[key] = baseUrl + '/' + encodeURIComponent(path.basename(this.name, path.extname(this.name)) + '.jpeg');
        else this[key] = baseUrl + '/' + encodeURIComponent(this.name);
