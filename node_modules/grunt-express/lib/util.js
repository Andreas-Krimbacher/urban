...
exports.runServer = function (grunt, options) {
    ...
    var proxyServer = {server: new httpProxy.HttpProxy({ target: proxyOption }),
                        config: proxyOption};

    var proxyMiddleware = function (req, res, next) {
        var proxied = false
        if (!proxied && req && req.url.lastIndexOf(proxyServer.config.context, 0) === 0) {
            proxyServer.server.proxyRequest(req, res);
