...
Timeline.DefaultEventSource.Event = function(args) {
  ...
  this._description = SimileAjax.HTML.deEntify(args.description);
    ...
    if(args.onClick){
        this._onClick = args.onClick; //changed: new
    }
    else{
        this._onClick = function(){};
    }

    this._rank = args.rank ? args.rank : 1;
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    getOnClick:    function() { return this._onClick; }, //changed: new
    getRank:    function() { return this._rank; }, //changed: new
